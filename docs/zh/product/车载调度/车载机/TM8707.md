...
<br />
<img alt='键盘' src='/产品/车载调度/车载机/TM8707/键盘.png' width='500' />
...
## 九、安装图纸示例
<br />
<img alt='安装示例' src='/产品/车载调度/车载机/TM8707/安装示例.png' width='500' />
...
<img alt='键盘不通讯' src='/产品/车载调度/车载机/TM8707/键盘不通讯.png' width='500' />
...
<img alt='不注册' src='/产品/车载调度/车载机/TM8707/不注册.png' width='500' />

<Table :table='deviceNotRegistTable'></Table>

### 4、Init sim card
<br />
<img alt='Init sim card' src='/产品/车载调度/车载机/TM8707/Init sim card.png' width='500' />
...
<img alt='不定位' src='/产品/车载调度/车载机/TM8707/不定位.png' width='500' />

<Table :table='deviceNoGpsTable'></Table>

### 6、不自动报站
<br />
<img alt='不报站' src='/产品/车载调度/车载机/TM8707/不报站.png' width='500' />

<Table :table='deviceNoBroadcastStationTable'></Table>

### 7、出站不报起步
<br />
<img alt='不报起步' src='/产品/车载调度/车载机/TM8707/不报起步.png' width='500' />

<Table :table='deviceNoBroadcastOutStationTable'></Table>

### 8、麦克不能喊话
<br />
<img alt='不注册' src='/产品/车载调度/车载机/TM8707/麦克不能喊话.png' width='500' />
...
const devicePictures = [
    {name: '前面板', label:'前面板', src: '/产品/车载调度/车载机/TM8707/TM8707.png'},
    {name: '后面板', label:'后面板', src: '/产品/车载调度/车载机/TM8707/后面板.png'},
    {name: '键盘', label:'键盘', src: '/产品/车载调度/车载机/TM8707/键盘.png'},
    {name: '8707电源线', label:'8707电源线', src: '/产品/车载调度/车载机/TM8707/8707电源线.png'},
    {name: '8802电源线', label:'8802电源线', src: '/产品/车载调度/车载机/TM8707/8802电源线.png'},
    {name: '8707信号线', label:'8707信号线', src: '/产品/车载调度/车载机/TM8707/8707信号线.png'},
    {name: 'CAN线', label:'CAN线', src: '/产品/车载调度/车载机/TM8707/CAN线.png'},
]
